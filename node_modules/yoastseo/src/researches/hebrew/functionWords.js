...
exports.default = function () {
	return {
		...
		all: [].concat(cardinalNumerals, ordinalNumerals, personalPronouns, demonstrativePronouns, interrogatives, quantifiers, reflexivePronouns, indefinitePronouns, prepositions, conjunctions, interviewVerbs, intensifiers, auxiliariesAndDelexicalizedVerbs, generalAdjectivesAdverbs, interjections, recipeWords, timeWords, vagueNouns, miscellaneous)
	};
};
